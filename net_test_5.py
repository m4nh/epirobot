...
# MODEL
model = EpinetSimple(11, 3, 1, "epi_turned_0", "media/Checkpoints/")
...
# DATASET
dataset = EpiSingleDisparityDataset(folder='/tmp/train', crop_size=128, focal=2000, max_disparity=255)
...
for epoch in range(50001):
    ...
    for index, batch in enumerate(training_generator):
        ...
        print(input.shape)
        rgb = dataset.displayableImage(input[0],0)
